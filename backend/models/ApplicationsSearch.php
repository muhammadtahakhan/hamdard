...
class ApplicationsSearch extends Applications
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'nic', 'dob', 'email', 'mobile', 'phone', 'nationality', 'gender', 'address', 'f_name', 'f_nic', 'f_occupation', 'f_email', 'f_mobile', 'f_phone', 'f_nationality', 'f_current_address', 'campus', 'student_type', 'f_perminant_Address', 'enable_flag', 'last_updated_date', 'creation_date', 'print_id', 'bpm_session'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'bpm_session', $this->bpm_session]);

...
/**
 * BoardUniversitySearch represents the model behind the search form about `backend\models\BoardUniversity`.
 */
class BoardUniversitySearch extends BoardUniversity
{
    /**
     * @inheritdoc
     */
